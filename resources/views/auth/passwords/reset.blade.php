                                ...
                                <div class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                                    <form method="POST" action="{{ route('password.update') }}" >
                                        ...
                                        <div class="u-form-email u-form-group">
                                            ...
                                            <input type="password" placeholder="Entre votre mot de passe" id="email-ed73" name="password"
                                                   class=" form-control @error('password') is-invalid @enderror u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
                                            @error('password')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        <div class="u-form-email u-form-group">
                                            <label for="email-ed73" class="u-label">Confirmer le mot de passe</label>
                                            <input type="password" placeholder="Entre votre mot de passe" id="email-ed73" name="password_confirmation"
                                                   class=" form-control u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
                                        </div>
