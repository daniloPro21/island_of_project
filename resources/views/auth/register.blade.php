...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/Inscription.css') }}" media="screen">
                                ...
                                <div class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                                    <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="u-form-group u-form-name u-form-group-1">
                                            ...
                                            <input type="text" placeholder="Entrez votre nom d'utilisateur" id="name-e7d2" name="name" class=" form-control @error('name') is-invalid @enderror u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-1">
                                            @error('email')
                                        ...
                                        <div class="u-form-email u-form-group u-form-group-4">
                                            ...
                                            <input type="password" placeholder="Definir votre mot de passe " id="email-ed73" name="password_confirmation" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                                        </div>
                                        <div class="u-form-email u-form-group u-form-group-4">
                                            <label for="email-ed73" class="u-label">Avatar</label>
                                            <input type="file" placeholder="Definir un avatar" id="email-ed73" name="file" class="  form-control @error('file') is-invalid @enderror u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                                            @error('file')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
