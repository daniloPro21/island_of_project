                        ...
                        <div class="u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-3">
                            <div class="u-container-layout u-valign-bottom-xs u-container-layout-3">
                                ...
                                <div class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                                   <h3>Un Email de vealidation vous a ete envoyer verifiez vos mail pour valider votre Inscription</h3>
                                    <p>Si vous n'avez pas recu de mail cliquer ici pour un nouveau email de verification</p>
                                </div>
                                <a href="{{ route('verification.resend') }}" class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-2">Ici</a>
                            </div>
                        </div>
                    </div>
                </div>
