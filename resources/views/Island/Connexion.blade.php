              ...
              <div class="u-layout-col">
                <div class="u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-3">
                  <div class="u-container-layout u-valign-bottom-xs u-container-layout-3">
                    ...
                    <div class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                      <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form">
                        <div class="u-form-email u-form-group">
                          ...
                          <input type="email" id="name-ed73" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required" placeholder="Entrez votre adresse email">
                        </div>
                        <div class="u-form-email u-form-group">
                          <label for="email-ed73" class="u-label">Mot de passe</label>
                          <input type="password" placeholder="Entre votre mot de passe" id="email-ed73" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                        </div>
                    ...
                    <a href="Reset-Password.html" class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-2">Mot de passe oublier</a>
                    <a href="Inscription.html" class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-3">pas de compte ? Inscrivez-vous</a>
                    <a href="#" class="u-border-radius-33 u-btn u-btn-round u-button-style u-palette-1-dark-1 u-btn-4">Continuer avec Facebook</a>
                    <a href="#" class="u-border-radius-27 u-btn u-btn-round u-button-style u-palette-2-base u-btn-5">Continuer avec Google</a>
                  </div>
                </div>
              </div>
            </div>
