    ...
    @section('content')
        ...
        <section class="u-clearfix u-section-2" id="sec-77f0">
            <div class="container mt-4 mb-4">
                ...
                <div class="row">
                    <form action="{{ route('p.update', ['projets' => $projets]) }}" method="post"  enctype="multipart/form-data" style="padding: 21px;">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" value="{{ $projets->logo }}" placeholder="Logo" id="text-1af5" name="logo"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $projets->titre }}" placeholder="Nom du projet" id="name-6255" name="titre"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea  placeholder="Breve description du projet" rows="4" cols="50" id="message-6255" name="description"
                                          class="u-border-2 u-border-grey-75 u-input u-input-round u-white">{{$projets->description}}</textarea>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <textarea placeholder="Description du probleme"  rows="4" cols="50" id="textarea-e662" name="probleme"
                                          class="u-border-2 u-border-grey-75 u-input u-input-round u-white u-input-6" >{{$projets->probleme}}</textarea>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input placeholder="stade du projet" value="{{ $projets->nature  }}" rows="4" cols="50" id="textarea-47c1" name="nature"
                                       class="u-border-2 u-border-grey-75 u-input u-input-round u-white u-input-8" type="text">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="text-fda2" class="u-label">Lien vers le site web</label>
                                <input type="text" value="{{ $projets->site }}" placeholder="Lien vers le site web" id="text-fda2" name="site"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $projets->video }}" placeholder="Lien vers le pick video" id="text-d003" name="video"
