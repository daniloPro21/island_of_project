@extends('layouts.app')
   @section('content')
       ...
       <section class="u-align-center u-clearfix u-white u-section-3" id="sec-22b7">
           <div class="u-clearfix u-sheet u-sheet-1">
               <h2 class="u-text u-text-palette-2-base u-text-1">Touts vos Projets</h2>
                   <div class="col-sm-6">
                               ...
                               <div class="u-container-layout u-valign-bottom-md u-valign-bottom-sm u-container-layout-1">
                                   ...
                                   <div class="u-align-left-lg u-align-left-md u-align-left-xl u-container-style u-expanded-width u-group u-group-2">
                                       <div class="u-container-layout u-valign-top u-container-layout-3">
                                           ...
                                           <h4 class="u-align-left-lg u-align-left-xl u-align-right-md u-align-right-sm u-align-right-xs u-text u-text-4">{{$ts->adresse}}</h4>
                                   ...
                                   <div class="u-container-style u-expanded-width u-group u-group-3">
                                       <div class="u-container-layout u-valign-top-lg u-valign-top-xs u-container-layout-4">
                                           <a href="{{ route('edit', ['project' => $ts->id]) }}" class="u-border-radius-10 u-btn u-btn-round u-button-style u-white u-btn-2">&nbsp;&nbsp;&nbsp&nbsp;&nbsp;Modifier</a>
                                           <form method="post" action="{{ route('p.delete', ['id' => $ts->id]) }}">
                                               @csrf
                                               @method('DELETE')
                                               <button type="submit" class="u-border-2 u-border-palette-2-base u-border-radius-10 u-btn u-btn-round u-button-style u-none u-btn-2">Supprimer</button>
                                           </form>
                                       </div>
                                   </div>
